...
const userSchema = new Schema(
    {
        ...
        gender: { type: int, enum: [0, 1, 2], default: 0 }, // 0: not specified, 1: Male 2:Female
        ...
        account_type: { type: Number, default: 1 }, // 1: Patient, 2: Service Provider 1, 3: Service Provider 2
        ...
        sign_up_via: { type: Number, default: 1 }, // 1: app, 2: Google, 3: Apple
        ...
        theme_color_id: { type: String },
        currency_id: { type: String },

        is_first_workzone_created: { type: Boolean, default: false },
